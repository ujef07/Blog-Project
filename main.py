...
# print("MAIL_ADDRESS:", MAIL_ADDRESS)  # Should print your email address
# print("MAIL_APP_PW:", MAIL_APP_PW)    # Should print your app password or **** if you mask it for security reasons
@app.route("/contact", methods=["GET", "POST"])
def contact():
...
#         connection.starttls()
#         connection.login(MAIL_ADDRESS, MAIL_APP_PW)
#         connection.sendmail(from_addr=MAIL_ADDRESS, sent=email_message)
